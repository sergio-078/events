...
urlpatterns = [
    ...
    # ============================================================
    # СПРАВОЧНИКИ (namespace events:, имя = <model_name>_<action>)
    # ============================================================
    # Service
    ...
    # Department (было Organization*View — исправлено)
    path('dictionaries/departments/', views_dict.DepartmentListView.as_view(), name='department_list'),
    path('dictionaries/departments/create/', views_dict.DepartmentCreateView.as_view(), name='department_create'),
    path('dictionaries/departments/<int:pk>/edit/', views_dict.DepartmentUpdateView.as_view(), name='department_update'),
    path('dictionaries/departments/<int:pk>/delete/', views_dict.DepartmentDeleteView.as_view(), name='department_delete'),
